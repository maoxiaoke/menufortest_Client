...
void CClientSocket::OnConnect(int nErrorCode)
{
	...
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->m_ServerPort.EnableWindow(false);
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->m_ConnectButton.EnableWindow(false);
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->m_DisconnectButton.EnableWindow();
...
void CClientSocket::OnClose(int nErrorCode)
{
	...
	//控件禁用
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->ServerIP.EnableWindow();
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->m_ServerPort.EnableWindow();
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->m_ConnectButton.EnableWindow();
	((CmenuDlg*)(AfxGetApp()->m_pMainWnd))->m_DisconnectButton.EnableWindow(false);
