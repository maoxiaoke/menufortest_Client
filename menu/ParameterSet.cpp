...
ON_CBN_SELCHANGE(IDC_ATUOARQ_COMBO, &CParameterSet::OnCbnSelchangeAtuoarqCombo)
END_MESSAGE_MAP()
...
void CParameterSet::OnCbnSelchangeProtocolmodeCombo() //点击模式选择组合框->协议工作方式
{
	// TODO:  在此添加控件通知处理程序代码
...
void CParameterSet::OnCbnSelchangeAtuoarqCombo()
{
	// TODO:  在此添加控件通知处理程序代码
}
